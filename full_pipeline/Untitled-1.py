...
group_name = "test_3" # This needs to be your Group name e.g: group-01, group-02, group-03, group-04, group-05, ...
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--transcribe",
        action="store_true",
        help="Download audio files from GCS bucket, transcribe and upload",
    )
    ...
    parser.add_argument(
            ...
            "--generate",
            action="store_true",
        help="Download text from bucket, genrate prompt, and upload",
    )
    ...
    parser.add_argument(
            ...
            "--stt",
            action="store_true",
        help="Download generated text, stt, and upload",
    )
    ...
    parser.add_argument(
            ...
            "--translate",
            action="store_true",
        help="Download generated text, translate to another langauge, and upload",
    )
    ...
    parser.add_argument(
            ...
            "--stt_translation",
            action="store_true",
        help="Download translated text and then run stt and upload",
    )
